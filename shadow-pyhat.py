...
mqttShadowClient.configureEndpoint("aabhfs6th5els-ats.iot.eu-west-1.amazonaws.com",8883)
mqttShadowClient.configureCredentials("./certs/AmazonRootCA1.pem","./certs/privateKey.pem","./certs/certificate.pem")
